...
namespace ChintakExtensions\CustomerLogin\Block\Adminhtml\Form\Field;
...
class Reasons extends AbstractFieldArray
{
     ...
     * @var string
     */
    protected $_template = 'ChintakExtensions_CustomerLogin::system/config/form/field/array.phtml';
